...
export default function HomePage() {
  return (
    <div className="bg-background text-foreground py-8 max-w-6xl mx-auto px-6 w-full h-[500px] relative">
      <Image src="/Image.png" alt="Home Image" fill className="object-cover" />
